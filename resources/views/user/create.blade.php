  ...
  <div class="container mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <input type="text" class="form-control" name="name" placeholder="Masukan Nama Murid">
            </div>

            <div class="mb-4">
                <label for="alamat" class="form-label">Email Murid</label>
               <input type="email" name="email" placeholder="Masukan Email Murid" class="form-control">
            </div>
