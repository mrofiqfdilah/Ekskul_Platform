...
<body>
    ...
    <div class="content">
        ...
        data-aos-easing="ease-in-sine" style="width: 980px; margin-left:260px;">
            <div class="card-body">
                <a href="{{ route('user.create') }}" style="background-color:#0D6EFD; height:40px; color:#fff;" class="btn  mb-3"><p style=" letter-spacing:1px; position: relative; top:-5px;">Tambah Data <i class="ri-add-circle-line" style="font-size: 20px; position: relative; top:5px;"></i></p></a>
                ...
                <table>
                    <tr>
                        ...
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Email</div></th>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $user->name }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $user->email }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px;">
                            <div class="d-flex justify-content-center"> <!-- Edit button -->
                                <a href="{{ route('user.edit', $user->id) }}" class="btn btn-primary"><i class="ri-pencil-fill"></i></a>
                                <!-- Delete button -->
