...
<body>
    ...
    <div class="content">
        ...
        data-aos-easing="ease-in-sine" style="width: 980px; margin-left:260px;">
            <div class="card-body">
                <a href="{{ route('gabung.create') }}" style="background-color:#0D6EFD; height:40px; color:#fff;" class="btn  mb-3"><p style=" letter-spacing:1px; position: relative; top:-5px;">Tambah Data <i class="ri-add-circle-line" style="font-size: 20px; position: relative; top:5px;"></i></p></a>
                ...
                <table>
                    <tr>
                        ...
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Nama Siswa</div></th>
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Ekskul Didaftar</div></th>
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Jadwal Daftar</div></th>
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Actions</div></th>
                    </tr>
                    @foreach ($gabungData as $no => $gabung)
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $gabung->user->name }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $gabung->ekskul->namaeskul }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $gabung->created_at }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px;">
                            <div class="d-flex justify-content-center"> <!-- Edit button -->
                                <a href="" class="btn btn-primary"><i class="ri-pencil-fill"></i></a>
                                <!-- Delete button -->
                                <form action="{{ route('gabung.destroy', $gabung->id) }}" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                    @csrf
                                    @method('DELETE')
