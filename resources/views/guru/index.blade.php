            ...
            <div class="card-body">
                ...
                <table>
                    <tr>
                        ...
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Nama Guru</div></th>
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Email Guru</div></th>
                        <th style="letter-spacing:0.5px; border: 1px solid #ddd; padding: 8px;"><div class="d-flex justify-content-center">Actions</div></th>
                    </tr>
                    @foreach ($gurus as $no => $hasil)
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $hasil->name }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">{{ $hasil->email }}</td>
