  ...
  <div class="container mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <input type="text"  value="{{ $eskul->namaeskul }}"  class="form-control" name="namaeskul" placeholder="Masukan Nama Ekskul">
            </div>

            <div class="mb-4">
                <label for="alamat" class="form-label">Jadwal Hadir</label>
               <input type="text" value="{{ $eskul->deskripsi }}" name="deskripsi" placeholder="Masukan Jadwal Ekskul" class="form-control">
            </div>

            <div class="mb-4">
                <label for="nourut" class="form-label">Tempat Pelaksanaan</label>
                <input type="text" class="form-control" value="{{ $eskul->jadwaltempat }}" name="jadwaltempat" placeholder="Masukan Tempat Pelaksanaan">
            </div>
            ...
            <div class="mb-4">
              ...
              <select name="guru_id" class="form-control">
                ...
                <option value="{{ $guru->id }}" {{ $selectedGuru == $guru->id ? 'selected' : '' }}>{{ $guru->name}}</option>
            @endforeach
